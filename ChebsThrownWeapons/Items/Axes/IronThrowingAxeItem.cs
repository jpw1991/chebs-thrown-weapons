...
{
    public class IronThrowingAxeItem : ThrowingAxeItem
    {
        public override string ItemName => "ChebGonaz_ThrowingAxeIron";
        public override string PrefabName => "ChebGonaz_ThrowingAxeIron.prefab";
        public override string NameLocalization => "$chebgonaz_throwingaxeiron";
