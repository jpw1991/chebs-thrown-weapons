...
if __name__ == '__main__':
    ...
    file_pattern_replacements = [
        FilePatternReplacement('ChebsThrownWeapons/Properties/AssemblyInfo.cs',
                               'AssemblyVersion\\([".0-9]+\\)',
                               f'AssemblyVersion("{version}.0")'),
        FilePatternReplacement('ChebsThrownWeapons/Properties/AssemblyInfo.cs',
                               'AssemblyFileVersion\\([".0-9]+\\)',
                               f'AssemblyFileVersion("{version}.0")'),
        FilePatternReplacement('ChebsThrownWeapons/ChebsThrownWeapons.cs',
                               'PluginVersion = [".0-9]+',
                               f'PluginVersion = "{version}"'),
        FilePatternReplacement('ChebsThrownWeapons/Package/manifest.json',
                               '"version_number": [".0-9]+',
